...
<div class="input-group">
    ...
    <input type="text" id="title" class="form-control" placeholder="" aria-describedby="basic-addon1">
</div>

<div class="input-group">
    <span class="input-group-addon" id="basic-addon2">作者</span>
    <input type="text" id="author"class="form-control" placeholder="" aria-describedby="basic-addon2" value="<?=$author?>">
</div>

<form method="post">
    <textarea id="summernote" name="summernote"></textarea>
    <button type="button" class="btn btn-success" onclick="addarticle()">（提交）Success</button>
</form>
